  ...
  if (message.author.bot || !message.guild) return;
    if (message.content === "tumumod") {
      ...
      const embed = new MessageEmbed()
        ...
        .addField(`1.ツムツムModMenu_12.6.1`, `> 500円`)
...
client.on('interactionCreate', async (interaction) => {
    ...
    try {
        ...
        const embed = new MessageEmbed()
        .setTitle("ツムツムModMenu販売")
        .setDescription(`https://www.mediafire.com/file/leemg7to6290uny/%25E3%2583%2584%25E3%2583%25A0%25E3%2583%2584%25E3%2583%25A0ModMenu_12.6.1.apk/file\n\nご購入ありがとうございます\nご確認頂けましたら <#1399314060373135400> に実績記入をお願い致します`)
        .setColor("RANDOM")
        .setTimestamp();
